...
Local Windows / Python 3.12.10: **84 tests, 83 passed, one symlink test skipped**.
...
Application display: MSTTools v1.2. Package metadata: msttool 1.2.2. GitHub release tag: v1.2.0.
